...
class SellersControllerTest < ActionController::TestCase
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post :create, seller: { adress_id: @seller.adress_id, company_id: @seller.company_id, cpf: @seller.cpf, name: @seller.name, salario: @seller.salario }
    end
  ...
  test "should update seller" do
    patch :update, id: @seller, seller: { adress_id: @seller.adress_id, company_id: @seller.company_id, cpf: @seller.cpf, name: @seller.name, salario: @seller.salario }
    assert_redirected_to seller_path(assigns(:seller))
  end
